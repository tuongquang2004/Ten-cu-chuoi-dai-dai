...
export function Tile({ icon, label, href, onClick }: TileItem) {
  const content = (
<<<<<<< HEAD
    <div className="group flex flex-wrap min-w-44 flex-col items-center gap-[10px] bg-white px-4 py-5 text-[14px]">
      <span className="text-slate-600 group-hover:text-slate-900 min-h-[33px] flex items-center justify-center">{icon}</span>
...
=======
    <div className="group flex flex-wrap w-44 flex-col items-center gap-[10px] bg-white px-4 py-5 text-[14px]">
      ...
      <span className="font-medium text-slate-700 group-hover:text-slate-900 text-center">
        {label}
      </span>
