...
export default function Pagination({
  ...
  return (
    <div
      className={`flex items-center px-2 py-3 border-t border-[#E4E7EC] bg-white rounded-b-lg ${className}`}
    >
      ...
      <div className="flex items-center gap-2 border-l border-[#E4E7EC] pl-3">
        <div className="relative">
          ...
          <span className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-[#344054]">
            ▾
          </span>
        </div>
      </div>
