      ...
      <Layout>
        <div className="flex flex-1 h-full">
          <div className="px-12 p-6 flex flex-col gap-3 w-full">
            ...
            <PageHeader
              title="Manage Referral Sources"
              subtitle="Create or Edit Referral sources entries"
            />
            <div className="grid grid-cols-1 gap-3 xl:grid-cols-2">
              <div className="flex items-center">
                <SearchBar
                  ...
                  iconAlign="left"
                  buttonAlign="right"
                  className="border border-[#98A2B3] h-full min-w-[417px] placeholder:text-[14px]"
                />
              </div>
          ...
          {isShow && (
            <RightBar onClose={cancelAction}>
              <DataForm
                ...
                onSubmit={form.action === "add" ? addSource : editSource}
              >
                <div>
                  <CommonInput
